...
class VegetableDetailPage extends StatelessWidget {
  ...
  VegetableDetailPage({required this.vegetableData});


  @override
  Widget build(BuildContext context) {
    final fireStore = FirebaseFirestore.instance.collection('vegetable').doc(vegetableData['vid']).snapshots();
print(vegetableData['vid']);
    ...
    return StreamBuilder<DocumentSnapshot>(
            ...
            builder: (BuildContext context, AsyncSnapshot<DocumentSnapshot> snapshot) {
              ...
              List<String> dieukien = (snapshot.data!.get('dieukien') as String).split(', ');
              List<String> uudiem = (snapshot.data!.get('uudiem') as String).split(', ');
              List<String> nhuocdiem = (snapshot.data!.get('nhuocdiem') as String).split(', ');
