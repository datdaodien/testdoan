...
class DichBenhDetailPage extends StatelessWidget {
  final Map<String, dynamic> dichbenhData;

  DichBenhDetailPage({required this.dichbenhData});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Chi tiết dịch bệnh'),
      ),
                ...
                FutureBuilder<DocumentSnapshot>(
                  ...
                  builder: (BuildContext context, AsyncSnapshot<DocumentSnapshot> snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      return Center(child: Text('Dữ liệu không tồn tại'));
                    } else {
